...
def main():
    ...
    door_motion_sensor_simulator = DoorMotionSensorSimulator(output_queue)
    ...
    door_motion_sensor_simulator.start()
    room_pir_simulator.start()
    room_dht_simulator.start()

    thread_list.extend([dht_simulator, door_switch_simulator, door_sensor_simulator, door_light_simulator,
                        door_ultrasonic_simulator, door_buzzer_simulator, door_motion_sensor_simulator,
